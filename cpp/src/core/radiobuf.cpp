...
string radTIOBuffer::warn_ar[] = {
	...
	"Radia::Warning020::::GPU interaction-matrix assembly is not available for this model (an element is neither a polyhedron nor a RecMag); computation performed on CPU.\0",
